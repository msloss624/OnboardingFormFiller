      ...
      <div className="flex items-center gap-2 mb-1">
        ...
        {onRetry && showRetry && (
          <button
            ...
            className="flex items-center gap-1 rounded px-2 py-0.5 text-xs text-gray-500 hover:bg-gray-100 hover:text-[#1E4488] disabled:opacity-50"
          >
            {retrying ? (
              <span className="inline-block h-3 w-3 animate-spin rounded-full border-2 border-[#1E4488] border-t-transparent" />
            ) : (
